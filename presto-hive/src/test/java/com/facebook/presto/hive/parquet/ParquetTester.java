...
public class ParquetTester
{
            ...
            long modificationTime)
    {
        ...
        HiveBatchPageSourceFactory pageSourceFactory = new ParquetPageSourceFactory(FUNCTION_AND_TYPE_MANAGER.getFunctionAndTypeResolver(), FUNCTION_RESOLUTION, HDFS_ENVIRONMENT, new FileFormatDataSourceStats(), parquetMetadataSource);
