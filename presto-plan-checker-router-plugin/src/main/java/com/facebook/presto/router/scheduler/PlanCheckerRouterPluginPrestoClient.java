...
public class PlanCheckerRouterPluginPrestoClient
{
    ...
    public PlanCheckerRouterPluginPrestoClient(URI planCheckerClusterURI, URI javaRouterURI, URI nativeRouterURI, Duration clientRequestTimeout, boolean javaClusterFallbackEnabled, RequestStats requestStats)
    {
