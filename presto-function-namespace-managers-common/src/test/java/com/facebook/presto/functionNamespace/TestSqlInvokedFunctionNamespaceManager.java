...
public class TestSqlInvokedFunctionNamespaceManager
{
    ...
    public void testErrorHandling()
    {
        ...
        assertPrestoException(() -> functionNamespaceManager.getFunctionMetadata(new
                SqlFunctionHandle(
                        FUNCTION_POWER_TOWER_DOUBLE.getFunctionId(),
                "123",
                FUNCTION_POWER_TOWER_DOUBLE.getSignature().getReturnType())),
                GENERIC_USER_ERROR,
                "Error fetching function metadata");
        ...
        assertPrestoException(() -> functionNamespaceManager.getScalarFunctionImplementation(new
                SqlFunctionHandle(
                        FUNCTION_POWER_TOWER_DOUBLE.getFunctionId(),
                "123",
                FUNCTION_POWER_TOWER_DOUBLE.getSignature().getReturnType())), GENERIC_INTERNAL_ERROR, "Error getting ScalarFunctionImplementation for handle: unittest\\.memory\\.power_tower\\(double\\):123");
    }
