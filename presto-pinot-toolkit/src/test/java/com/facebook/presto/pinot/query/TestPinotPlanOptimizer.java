        ...
        extends TestPinotQueryBase
{
    ...
    {
        PinotQueryGenerator pinotQueryGenerator = new PinotQueryGenerator(pinotConfig, functionAndTypeManager.getFunctionAndTypeResolver(), functionAndTypeManager.getFunctionAndTypeResolver(), standardFunctionResolution);
        PinotPlanOptimizer optimizer = new PinotPlanOptimizer(pinotQueryGenerator, functionAndTypeManager.getFunctionAndTypeResolver(), functionAndTypeManager.getFunctionAndTypeResolver(), logicalRowExpressions, standardFunctionResolution);
