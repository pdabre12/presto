        ...
        extends TestDruidQueryBase
{
            ...
            Map<String, String> outputVariables)
    {
        ...
        DruidQueryGenerator.DruidQueryGeneratorResult druidQueryGeneratorResult = new DruidQueryGenerator(functionAndTypeManager.getFunctionAndTypeResolver(), functionAndTypeManager.getFunctionAndTypeResolver(), standardFunctionResolution).generate(planNode, sessionHolder.getConnectorSession()).get();
